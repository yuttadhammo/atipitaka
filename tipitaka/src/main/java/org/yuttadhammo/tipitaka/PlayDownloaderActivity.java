 ...
 */
public class PlayDownloaderActivity extends Activity implements IDownloaderClient {
    private static final String LOG_TAG = "LVLDownloader";
    private static final String TAG = "PlayDownloaderActivity";
    ...
    public static int getLatestExpansionVersion() {
        return 0;
    }
    ...
    private static final XAPKFile[] xAPKS = {
            new XAPKFile(
                    ...
                    65, // the version of the APK that the file was uploaded
                    // against
                    31355242L // the length of the file in bytes
            )
    };
        ...
        AsyncTask<Object, DownloadProgressInfo, Boolean> validationTask = new AsyncTask<Object, DownloadProgressInfo, Boolean>() {
            ...
            protected Boolean doInBackground(Object... params) {
                ...
                for (XAPKFile xf : xAPKS) {
                    ...
                    if(xf.mIsMain && latestVersion < xf.mFileVersion)
                        latestVersion = xf.mFileVersion;

                    String fileName = Helpers.getExpansionAPKFileName(
                            PlayDownloaderActivity.this,
                            xf.mIsMain, xf.mFileVersion);
                    if (!Helpers.doesFileExist(PlayDownloaderActivity.this, fileName,
                            xf.mFileSize, false))
                        return false;
                    fileName = Helpers
                            .generateSaveFileName(PlayDownloaderActivity.this, fileName);
                    ZipResourceFile zrf;
                ...
                editor.putInt("latest_extension_version",latestVersion);
                editor.commit();
    ...
    private void initializeDownloadUI() {
        mDownloaderClientStub = DownloaderClientMarshaller.CreateStub
                (this, PlayDownloaderService.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!expansionFilesDelivered()) {
            ...
            try {
                Intent launchIntent = PlayDownloaderActivity.this
                        .getIntent();
                Intent intentToLaunchThisActivityFromNotification = new Intent(
                        PlayDownloaderActivity
                                .this, PlayDownloaderActivity.this.getClass());
                ...
                int startResult = DownloaderClientMarshaller.startDownloadServiceIfRequired(this,
                        pendingIntent, PlayDownloaderService.class);
